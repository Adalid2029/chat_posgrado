...
foreach ($listar as $usuario):?>
			...
			<td> 
			<a href="editar/<?php echo $usuario->_id?>"class="btn btn-warning" type="button"><i class="bi bi-pen-fill"></i>
			...
			<a href="borrar/<?php echo $usuario->_id?>"class="btn btn-primary" type="button"><i class="bi bi-trash-fill"></i>
